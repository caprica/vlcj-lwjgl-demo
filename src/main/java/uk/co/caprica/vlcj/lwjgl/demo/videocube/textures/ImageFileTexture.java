...
/**
 * Utility class that provides for generation of textures from image files.
 */
public final class ImageFileTexture {

    /**
     * Create a texture from an image file.
     * <p>
     * Note that textures created in this was cannot later be updated.
     *
     * @param filePath path to the image file
     * @return texture id
     */
    public static int imageFileTexture(String filePath) {
        int width, height;
